        ...
        if (seconds_02 > 30) {
        	...
        	$.ajax({
                ...
                success: function (result) {
                    ...
                    storeResultData(result,seconds_02);
                    calculateInterval_02(result);
                    drawOnChart();
                    if (seconds_02 < 10) $('#timer02').text('00:0' + seconds_02);
                    else $('#timer02').text('00:' + seconds_02);
                    seconds_02++;
                },
                error: function () {
...
const storeResultData =(result, seconds_02)=> {
    console.log(chartDataset);
    chartDataset.timeData.push(seconds_02);
    chartDataset.resultData.ci.push(result.payload.ci);
    chartDataset.resultData.vi.push(result.payload.vi);

    chart_02.data.labels= chartDataset.timeData;
    chart_02.data.datasets[0].data =chartDataset.resultData.ci;
    chart_02.data.datasets[1].data = chartDataset.resultData.vi;
    chart_02.update();

    resChart_02.data.labels= chartDataset.timeData;
    resChart_02.data.datasets[0].data =chartDataset.resultData.ci;
    resChart_02.data.datasets[1].data = chartDataset.resultData.vi;
    resChart_02.update();
